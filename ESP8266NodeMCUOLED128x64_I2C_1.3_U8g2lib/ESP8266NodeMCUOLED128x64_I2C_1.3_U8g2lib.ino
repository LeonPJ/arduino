...
static const unsigned char cross_bits[] U8X8_PROGMEM  = {// 矩陣可以寫中文
...
void u8g2_bitmap_overlay(uint8_t a) {
  ...
  if(a & 4)
    u8g2.drawXBMP(7, 17, cross_block_width, cross_block_height, cross_block_bits);// u8g2.drawXBMP(int x, int y,block_width, cross_height, matrix)------------------
